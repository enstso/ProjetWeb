...
router.group(() => {
  ...
  router.patch('/habits/:id/unarchive', [HabitsController, 'unarchive']).use(middleware.auth()) // unarchiver
})
router.get('/habits/:id/logs', [HabitLogsController, 'index']).use(middleware.auth())
router.group(() => {
